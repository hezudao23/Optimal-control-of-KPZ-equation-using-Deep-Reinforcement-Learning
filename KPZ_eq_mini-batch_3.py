# -*- coding: utf-8 -*-
"""
Created on Tue Mar 27 12:00:54 2018
...
# -*- coding: utf-8 -*-
"""
Created on Mon Mar 26 14:13:52 2018
...
num_hidden = [dim + 1, dim + 10, dim+20, dim + 10, dim + 10,  dim]
''' This is the lambda'''
#####
...
z = z_init()
A = A_init()
y_init = tf.Variable([2.0], dtype = tf.float32)
...
train_step = tf.train.RMSPropOptimizer(learning_rate).minimize(loss_sum, global_step=global_step)
